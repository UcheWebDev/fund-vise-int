<template>
  ...
  <VerifyModal :role="role" :isVisible="isVisible" @closeModal="closeModal" />
</template>
...
const loginWithGoogle = () => {
  googleTokenLogin({
    ...
    if (response) {
      ...
      server()
        .post("/enterpreneur/auth/verifyGoogleAccessToken", {
...
const onSubmit = handleSubmit((values) => {
  ...
  store
    .dispatch("signUpNewEnterprenuer", payload)
    .then((response) => {
