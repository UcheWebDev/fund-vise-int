      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
          ...
          <div class="connect-with-investor">
            <p class="gray">Connect with Entrepreneur</p>
            <ConnectPeople
              :users="allUsersList"
...
const title = ref("Enterprenuers");
const name = ref("ConnectEntrepreneurs");
...
const getAllUsers = async () => {
  server()
    ...
    .then((response) => {
      ...
      const users = filteredUsers.filter((item) => item.role != "investor");
